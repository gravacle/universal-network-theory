...
STAGE3_MODULE_NAME: Final[str] = (
    "authenticated_stage3_entry_adapter_stored_publication_v002"
)
...
SELF_FREEZE_SCHEMA: Final[str] = (
    "V012_STAGE3_STORED_PUBLICATION_FRAMING_COMPATIBILITY_SOURCE_FREEZE_V002"
)
...
def plan() -> dict[str, object]:
    ...
    return {
        "schema": "V012_STAGE3_STORED_PUBLICATION_FRAMING_COMPATIBILITY_PLAN_V002",
        "classification": (
