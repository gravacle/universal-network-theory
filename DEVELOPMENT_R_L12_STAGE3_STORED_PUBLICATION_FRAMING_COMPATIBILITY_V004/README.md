# Mutable Stage-3 exact pretty-input compatibility V004 candidate
...
V004 retains the independently reviewed V003 behavior and changes only the
registered A18 SHA-256 to the passing successor-lineage replay cross-gate
`61a46381...`. It admits that replay's exact compact frame.
